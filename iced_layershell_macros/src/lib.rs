    ...
    let (additional_variants, impl_quote) = match is_multi {
        true => {
            let additional_variants = quote! {
                ...
                SetBlurRegion{ id: iced_layershell::reexport::IcedId, callback: iced_layershell::actions::ActionCallback },
                ...
                impl #impl_gen TryInto<iced_layershell::actions::LayershellCustomActionWithId> for #ident #ty_gen #where_gen {
                    ...
                    fn try_into(self) -> Result<iced_layershell::actions::LayershellCustomActionWithId, Self::Error> {
                        ...
                        match self {
                            ...
                            Self::SetBlurRegion{ id, callback } => Ok(LayershellCustomActionWithId::new(Some(id), LayershellCustomAction::SetBlurRegion(callback))),
        ...
        false => {
            let additional_variants = quote! {
                ...
                SetBlurRegion(iced_layershell::actions::ActionCallback),
                ...
                impl #impl_gen TryInto<iced_layershell::actions::LayershellCustomActionWithId> for #ident #ty_gen #where_gen {
                    ...
                    fn try_into(self) -> Result<iced_layershell::actions::LayershellCustomActionWithId, Self::Error> {
                        ...
                        match self {
                            ...
                            Self::SetBlurRegion(callback) => Ok(LayershellCustomActionWithId::new(None, LayershellCustomAction::SetBlurRegion(callback))),
